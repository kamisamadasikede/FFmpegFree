...
func SetupRouter() *gin.Engine {
	...
	api.POST("/live/stream/start", contollers.StartLiveFileStream)
	api.POST("/live/stream/stop", contollers.StopLiveFileStream)
	api.GET("/live/stream/list", contollers.ListLiveFileStreams)
	api.GET("/live/health", contollers.GetLiveHealth)
	api.GET("/live/archives", contollers.GetLiveArchives)
	api.POST("/live/relay/start", contollers.StartRelay)
	api.POST("/live/relay/stop", contollers.StopRelay)
	api.GET("/live/relay/list", contollers.ListRelay)
